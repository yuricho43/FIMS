...
#nullable enable  //suppress the Warning CS8632
        ...
        private System.Threading.Timer? CloserSessionSaveTimer;
#nullable disable
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (Constants.SAVE_CLOSER_SESSION_DATA_AUTO)
            {
                ...
                CloserSessionSaveTimer = timer; // fire every 60 * 10 secs (10 min)
            }
